!function (r) {
    ...
    e.prototype.respChart = function (e, a, t, o) {
        ...
        Chart.controllers.line.prototype.draw = function () {
            ...
            var r = this.chart.chart.ctx, e = r.stroke;
            r.stroke = function () {
        ...
        Chart.controllers.doughnut = Chart.controllers.doughnut.extend({
            draw: function () {
                ...
                var r = this.chart.chart.ctx, e = r.fill;
                r.fill = function () {
        ...
        var l = e.get(0).getContext("2d"), c = r(e).parent();
        return function () {
            var n;
        ...
        var e = this;
        Chart.defaults.global.defaultFontFamily = '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif', r("#dash-daterange").daterangepicker({singleDatePicker: !0}), e.charts = this.initCharts(), this.initMaps(), r(window).on("resize", function (a) {
